...
paperweight {
    serverProject.set(project(":cider-server"))
    ...
    usePaperUpstream(providers.gradleProperty("paperRef")) {
        withPaperPatcher {
            ...
            apiOutputDir.set(layout.projectDirectory.dir("cider-api"))

            serverPatchDir.set(layout.projectDirectory.dir("patches/server"))
            serverOutputDir.set(layout.projectDirectory.dir("cider-server"))
        }
    }
}
...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("cz.mcjabko.cider:cider-api")
